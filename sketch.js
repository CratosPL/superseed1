...
function touchMoved() {
  ...
  // Obsługa przewijania w "info" i "tutorial"
  if (gameState === "info" || gameState === "tutorial") {
    let dy = touches[0].y - pmouseY; // Różnica w ruchu palca w osi Y
    scrollOffset -= dy; // Odwrócona logika, bo ruch palca w górę zwiększa scrollOffset
